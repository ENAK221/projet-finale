...
<body>
    ...
    <section class="quick-view">
        <h1 class="heading">Detail Produits</h1>
    ...
    <?php if (!empty($fetch_products['image_02'])): ?>
        <img src="uploaded_img/<?= htmlspecialchars($fetch_products['image_02'], ENT_QUOTES, 'UTF-8'); ?>" alt="">
    <?php endif; ?>

    <?php if (!empty($fetch_products['image_03'])): ?>
        <img src="uploaded_img/<?= htmlspecialchars($fetch_products['image_03'], ENT_QUOTES, 'UTF-8'); ?>" alt="">
    <?php endif; ?>
</div>
            ...
            <div class="content">
                ...
                <div class="flex-btn">
                    ...
                    <input type="submit" value=" Favoris" name="add_to_wishlist" class="option-btn">
                </div>
            </div>
        </form>
